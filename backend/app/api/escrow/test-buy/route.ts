...
export async function POST() {
  ...
  try {
    console.log("[escrow:test-buy] Starting deposit transaction");
    ...
    console.log("[escrow:test-buy] Submitted tx", tx.hash);
    const receipt = await tx.wait();
    console.log("[escrow:test-buy] Confirmed tx", receipt?.hash);
    ...
    console.error("[escrow:test-buy] Error", error);
    return NextResponse.json(
